...
const PRICES: Array<[string, Price]> = [
  ...
  ["grok-4.20-multi-agent-0309", { input: 1.25, cachedInput: 0.20, output: 2.50 }],
  ["grok-4.20",              { input: 1.25, cachedInput: 0.20, output: 2.50 }],
  ["grok-build-0.1",         { input: 1.00, cachedInput: 0.20, output: 2.00 }],
  ["grok-build",             { input: 1.00, cachedInput: 0.20, output: 2.00 }],
